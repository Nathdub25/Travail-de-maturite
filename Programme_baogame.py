...
can = Canvas(fen, width=860, height=500)
can.grid()
can.pack()
...
can.create_text(850, 60, text = "1", font = 180, fill = "blue")
can.create_text(850, 160, text = "2", font = 180, fill= "blue")
can.create_text(850, 260, text = "3", font = 180, fill= "red")
can.create_text(850, 360, text = "4", font = 180, fill= "red")
...
def adgr(event):
    ...
    if prm_tour == 2: #premier coup joueur 2 --> idem que pour le joueur 1 (voir prm_tour = 1)
        ...
        if li == 2 or li == 3:
            ...
            return
        if li == 0:
            messagebox.askokcancel("coup illégal", "Vous ne pouvez pas commencer à jouer sur cette rangée, veuillez choisir un emplacement sur la 2ème rangée.")
            return
        if li == 1:
            prm_tour = 3
            Aquiletour = 1
    ...
    while True :
        ...
        if len(jeu[dern_li][dern_co]) == 1: #si dernière graine attérit dans une case vide
            if dern_li == 2: #si la case vide se situe sur la rangée du haut (joueur 1)
            ...
            elif dern_li == 3: #Si la dernière graine attérit dans la rangée du bas(joueur 1)
                messagebox.askokcancel("Fin du tour", "C'est au tour du joueur 2 de jouer.")
                ...
                messagebox.askokcancel("Fin du tout", "C'est au tour du joueur 1 de jouer.")
            elif dern_li == 0:
                messagebox.askokcancel("Fin du tout", "C'est au tour du joueur 1 de jouer.")
